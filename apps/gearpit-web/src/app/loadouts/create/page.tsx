...
export default function CreateLoadoutPage() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-3rem)] bg-[#18181B] text-zinc-200">
            <div className="max-w-2xl mx-auto p-4 md:p-8 space-y-6 w-full mt-8">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-white flex items-center gap-3">Create Loadout</h1>
                    <p className="text-zinc-400 text-sm mt-1">Start a new packing list.</p>
                </div>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 bg-[#27272A] border border-zinc-800 p-6 rounded-md shadow-sm">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="e.g. Weekend Hike" className="bg-zinc-900 border-zinc-700 text-white placeholder:text-zinc-500" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea placeholder="Optional description..." className="bg-zinc-900 border-zinc-700 text-white placeholder:text-zinc-500" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="flex justify-end space-x-3 pt-4 border-t border-zinc-800">
                            <Button variant="ghost" type="button" onClick={() => router.back()} className="hover:bg-zinc-800 hover:text-white">Cancel</Button>
