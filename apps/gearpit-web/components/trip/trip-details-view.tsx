...
import { tripApi, Trip, TripItem } from "@/lib/api";
...
import { Shirt, Backpack, Tent, Zap, Utensils } from "lucide-react";
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1">
                        <GearCategoryCard
                            ...
                            totalWeight={categories.wearable.reduce((acc: number, ti: TripItem) => acc + (ti.item.weightGram * ti.quantity), 0)}
                    ...
                    <div className="lg:col-span-1">
                        <GearCategoryCard
                            ...
                            totalWeight={categories.pack.reduce((acc: number, ti: TripItem) => acc + (ti.item.weightGram * ti.quantity), 0)}
                    ...
                    <div className="lg:col-span-1">
                        <GearCategoryCard
                            ...
                            totalWeight={categories.essentials.reduce((acc: number, ti: TripItem) => acc + (ti.item.weightGram * ti.quantity), 0)}
                    ...
                    {/* Long Gear / Skis */}
                    {(categories.long_gear.length > 0 || categories.uncategorized.length > 0) && (
                        <div className="lg:col-span-1">
                            <GearCategoryCard
                                title="Long Gear & Other"
                                items={[...categories.long_gear, ...categories.uncategorized]}
                                totalWeight={[...categories.long_gear, ...categories.uncategorized].reduce((acc: number, ti: TripItem) => acc + (ti.item.weightGram * ti.quantity), 0)}
                    ...
                    {/* Consumables (if any separate display needed, or just put in pack) */}
                    {categories.consumable.length > 0 && (
                        <div className="lg:col-span-1">
                            <GearCategoryCard
                                title="Food & Consumables"
                                items={categories.consumable}
                                totalWeight={categories.consumable.reduce((acc: number, ti: TripItem) => acc + (ti.item.weightGram * ti.quantity), 0)}
