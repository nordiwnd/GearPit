...
func (s *gearService) CreateItem(ctx context.Context, name, description, manufacturer string, weight int, weightType domain.WeightType, category, brand string) (*domain.Item, error) {
	// プロパティをJSONとして構築
...
func (s *gearService) UpdateItem(ctx context.Context, id, name, description, manufacturer string, weight int, weightType domain.WeightType, category, brand string) (*domain.Item, error) {
